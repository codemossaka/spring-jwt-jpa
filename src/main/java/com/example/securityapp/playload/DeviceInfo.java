package com.example.securityapp.playload;

import com.example.securityapp.entity.DeviceType;
import com.example.securityapp.validation.annotation.NullOrNotBlank;
